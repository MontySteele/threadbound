...
kw({ id: 'covet', name: 'Covet', rule: 'After your partner picks a reward, spend a charge to take a card they passed over. +1 charge per elite; Barter at rest sites.', flavor: 'The rite has provisions for your kind.' });
